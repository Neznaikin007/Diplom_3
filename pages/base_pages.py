...
class BasePage:
    ...
    def wait_change_element(self, locator, element_text):
        return WebDriverWait(self.driver, 10).until((lambda d: ((element := d.find_element(*locator)) and element.text != element_text and element.text)))
    ...
    def wait_hide_element(self, locator):
